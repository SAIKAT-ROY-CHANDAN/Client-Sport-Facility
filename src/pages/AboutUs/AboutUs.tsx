            ...
            <section className="py-24">
              <div className="flex flex-col gap-y-8 xl:flex-row items-center max-w-6xl mx-auto mt-8 mb-20 rounded-lg ">
                <div className="ml-9 xl:ml-0">
                  ...
                  <p className="text-md xl:text-lg text-gray-500 font-sans w-10/12">Welcome to Sports Booking Platform! We simplify how you book and manage sports activities, from local leagues to major tournaments. With our user-friendly approach and commitment to innovation, finding and securing your next game has never been easier.</p>
                </div>
