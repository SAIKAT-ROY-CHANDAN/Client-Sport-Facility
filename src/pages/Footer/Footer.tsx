    ...
    return (
        <div className=" bg-[#12143D] min-h-[20vh] shadow-xl mt-20">
          <div className=" px-4 sm:px-6 lg:px-20">
            <div className=" text-[#ffffff] flex justify-center items-center flex-col">
              ...
              <div className="text-[#ffffff] flex justify-between items-center border-t-2 border-gray-100 w-full text-sm py-5 text-center sm:text-start">
